    ...
    public partial class FormRestore : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
                ...
                if (textBox1.Text != "")
            {
                    ...
                    System.IO.File.Delete(Application.StartupPath + "\\Stimulsoft.dll");
                    File.Copy(textBox1.Text, Application.StartupPath + "\\Stimulsoft.dll", true);
            }
            else
            {
