    ...
    public partial class FormSettings : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                strReq2 = "https://www.papiloo.ir/Papiloo/Register/Select_Pay.php?Serial=" + shenase;
                ...
                if (a[0] == "1")
                {
                    ...
                    strReq = "https://www.papiloo.ir/Papiloo/Register/Update_Pay.php?Serial=" + IDGenerator.GetCPUId();
        ...
        private void BtnRegisterInternet_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    System.Diagnostics.Process.Start("https://www.papiloo.ir/Laundry/index.php");
                }
                else
                {
